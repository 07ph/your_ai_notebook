  ...
  return (
    <div className="flex h-full w-56 shrink-0 flex-col border-r border-slate-200 bg-white">
      ...
      <div className="flex items-center justify-between border-b border-slate-200 px-4 py-3">
        <h2 className="text-sm font-semibold text-slate-800">笔记本</h2>
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            className="flex h-6 w-6 items-center justify-center rounded-md text-slate-400 transition-colors hover:bg-slate-100 hover:text-blue-600"
            title="新建笔记本"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
        ...
        {isCreating && (
          <div className="px-2 py-1">
            <input
              ...
              placeholder="笔记本名称..."
              className="w-full rounded-lg border border-blue-500 bg-white px-3 py-1.5 text-sm text-slate-800 outline-none focus:ring-2 focus:ring-blue-500/20"
            />
          </div>
        )}
          ...
          <div key={notebook.id} className="relative">
            ...
            >
              ...
              <span
                ...
                className="flex h-5 w-5 shrink-0 items-center justify-center rounded text-slate-400 opacity-0 transition-all hover:bg-slate-200 group-hover:opacity-100 cursor-pointer"
